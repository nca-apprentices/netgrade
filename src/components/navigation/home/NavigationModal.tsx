        ...
        <div className="nav-modal-list">
          ...
          >
            <div className="nav-modal-icon-box" slot="start">
              <IonIcon icon={ribbonOutline} className="nav-modal-icon" aria-hidden={true} />
            </div>
          ...
          >
            <div className="nav-modal-icon-box" slot="start">
              <IonIcon icon={documentTextOutline} className="nav-modal-icon" aria-hidden={true} />
            </div>
          ...
          >
            <div className="nav-modal-icon-box" slot="start">
              <IonIcon icon={calendarOutline} className="nav-modal-icon" aria-hidden={true} />
            </div>
